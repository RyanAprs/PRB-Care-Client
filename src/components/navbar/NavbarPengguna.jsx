  ...
  return (
    <>
      ...
      <header className="font-poppins top-0 left-0 right-0 z-50 flex justify-between bg-white dark:bg-blackHover text-white items-center py-4 md:py-6 px-5 md:px-10 transition-colors duration-300 ">
        ...
        <Link
            to="/"
            className="flex items-center justify-center font-poppins gap-1 text-2xl"
        >
          <svg xmlns="http://www.w3.org/2000/svg" width={`50`} viewBox="0 0 850 890">
            <g transform="translate(5, 5) scale(0.98)">
              ...
              <path
                  ...
                  stroke="none" fill="#54b383" fill-rule="evenodd"/>
            </g>
          </svg>
      ...
      >
        <div className="flex flex-col p-4 gap-4">
          ...
          <div
              className="text-lg p-3 rounded bg-[#fbfbfc] dark:bg-[#282828] text-[#989da0] dark:text-[#6e6e6e] border dark:border-none min-h-14">
